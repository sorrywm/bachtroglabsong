function FlySongSegmenterWAVmodSaveNoise(wav_file,song_range,params_path)
...
[Data, Sines, Pulses, Params, Noise] = ...
    FlySongSegmenterSaveNoise(song,[],params_path);

%save data
[pathstr, name, ext] = fileparts(wav_file);
outfile = [new_dir 'PS_' name 'withnoise.mat'];
save(outfile, 'Data','Sines','Pulses','Params','Noise','-v7.3');

%clear workspace
clear song Data Sines Pulses Params Noise
