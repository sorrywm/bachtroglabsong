function RunClusteringVirilis(wav_file, prevtempfile, whichsignal, ipiptl, segopts, doplots, remnoise)
    ...
    clearvars -except wav_file prevtempfile whichsignal ipiptl segopts doplots remnoise;
    ...
    if exist('minpulse','var')==0
        ...
        outname = strcat(outname,'mp',num2str(minpulse));
    end
